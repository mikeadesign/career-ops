...
export function run(cmd, args = [], opts = {}) {
  ...
  try {
    ...
    return execFileSync(exe, args, { cwd: ROOT, encoding: 'utf-8', timeout: 30000, ...opts }).trim(); // lgtm[js/uncontrolled-command-line] lgtm[js/shell-command-injection-from-environment]
  } catch (e) {
    return null;
  }
}
